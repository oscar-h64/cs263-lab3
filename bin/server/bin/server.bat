...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\commons-codec-1.8.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" server.Program %CMD_LINE_ARGS%
